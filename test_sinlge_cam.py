#!/usr/bin/env python3
## Based on Intel RealSense official example: https://github.com/IntelRealSense/librealsense/blob/development/wrappers/python/examples/python-tutorial-1-depth.py
## License: Apache 2.0
